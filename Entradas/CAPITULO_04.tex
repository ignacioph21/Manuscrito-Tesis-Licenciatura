...
\begin{figure}[!ht]
	...
	\caption{PDFs para la altura normalizada (\marksolid[blue]{0.4ex}) de las distintas mediciones (a) 0-3 Hz (b) 0-4 Hz (c) 0-5 Hz y (d) 0-6 Hz. Se muestra, además, la distribución gaussiana de media cero y desviación unidad (\markdashed[black]{0.4ex}) a modo comparativoa. } % a 
