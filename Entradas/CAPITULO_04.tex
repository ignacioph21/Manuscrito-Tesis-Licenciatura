...
En la Figura \ref{fig:workflow} se ejemplifica el procedimiento para la obtención de las ondas individuales. En primer lugar se identifican los cruces de cero de la señal, y se toma como una onda a la porción contenida entre dos cruces consecutivos en la misma dirección (ya sea hacia arriba o hacia abajo). Para cada onda individual se define una altura pico a pico $H_n$ y un período $T_n$ entre los cruces de cero, como muestra la Figura \ref{fig:workflow}b. La distribución conjunta de los valores para estas ondas se muestra en la Figura \ref{fig:jointporogression}. 
...
PROGRESIÓN Y LÍMTES. 
Para cada par de valores puede calcularse la pendiente de esa onda individual como: 
...
Lo siguiente que se buscó caracterizar fueron las cascadas de energía en el rango de gravedad y capilar. % rty  ay Y UUuu77 . 
